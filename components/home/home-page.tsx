...
import {
  AnimatedSignalPanel,
  VisualMedia,
} from "@/components/site/visual-media";
        ...
        <div className="grid flex-1 gap-8 py-6 lg:grid-cols-[0.98fr_0.82fr] lg:items-start lg:py-10 xl:gap-10 xl:py-12">
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <h1 className="max-w-4xl text-[clamp(3.2rem,6vw,6.2rem)] font-semibold leading-[0.92] tracking-[-0.07em] text-white">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="panel space-y-6">
            ...
            <p className="text-lg leading-8 text-foreground-soft">
              ...
              intelligent: fewer disconnected tools, fewer manual handoffs, and
              a clearer system for growth.
            </p>
          </div>
        </div>
      </ScrollReveal>
...
function TrustBridgeSection() {
  const signals = [
    {
      label: "Diagnosis first",
      title: "We clarify the operating problem before prescribing software.",
      text: "Most projects fail because teams build around symptoms. We map owners, workflows, bottlenecks, data movement, and success metrics before the implementation path is chosen.",
    },
    {
      label: "Commercial judgment",
      title: "Every build decision is tied to business leverage.",
      text: "The work is evaluated by speed, reliability, reduced manual effort, cleaner handoffs, and whether the system gives the business more control after launch.",
    },
    {
      label: "Execution confidence",
      title: "Clients get a practical build path, not vague technical theater.",
      text: "You see the system shape, risk areas, release assumptions, and what should happen next, so the project starts with clarity instead of guesswork.",
    },
  ];
  ...
  return (
    <SectionShell className="pb-18 lg:pb-20">
      <ScrollReveal>
        <div className="panel trust-bridge-panel">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <SectionHeading
              eyebrow="Why teams trust us"
              title="Strategy sharp enough for operators. Engineering deep enough for production."
              description="Niyyah Labs is positioned for founders and business teams who need someone to understand the commercial problem, shape the system, and then build it properly."
            />

            <div className="grid gap-4">
              {signals.map((signal) => (
                <article className="trust-signal-card" key={signal.label}>
                  <p className="stack-label">{signal.label}</p>
      ...
      <ScrollReveal>
        <div className="panel grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Link className="panel-subtle block" href="/process">
                ...
                <h3 className="mt-3 text-xl font-semibold tracking-[-0.03em] text-white">
                  See the delivery path from system mapping to release
                  readiness.
                </h3>
                <p className="mt-3 text-sm leading-7 text-foreground-soft">
                  Review the engagement flow, delivery artifacts, and how
                  decisions are made before implementation starts.
                </p>
              </Link>
              ...
              <Link className="panel-subtle block" href="/engineering">
                ...
                <h3 className="mt-3 text-xl font-semibold tracking-[-0.03em] text-white">
                  Explore the technical layer behind product, AI, and
                  integration work.
                </h3>
                <p className="mt-3 text-sm leading-7 text-foreground-soft">
                  See backend architecture, data sync, async workflows,
                  observability, and the implementation stack in one place.
                </p>
              </Link>
            </div>
          </div>
          ...
          <div className="panel-subtle process-hire-panel relative overflow-hidden lg:col-span-2">
            <div className="absolute inset-y-0 right-0 w-56 bg-[radial-gradient(circle_at_center,rgba(93,211,255,0.16),transparent_70%)]" />
            <div className="relative grid gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
              <div>
                <p className="stack-label">Why teams hire us</p>
                <h3 className="mt-4 max-w-lg text-2xl font-semibold tracking-[-0.04em] text-white sm:text-3xl">
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm text-foreground-muted">
              ...
              <a
                ...
                href="mailto:hello@niyyahlabs.dev"
              >
